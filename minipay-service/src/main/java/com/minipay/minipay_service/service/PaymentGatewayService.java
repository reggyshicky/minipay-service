...
public class PaymentGatewayService {
    ...
    public GatewayResult processPayment(BigDecimal amount, String phoneNumber) {
        log.info("Calling mock payment for amount: {}, phone: {}", amount, phoneNumber);
        ...
        if (amount.compareTo(failureThreshold) >= 0) {
            ...
            throw new PaymentProcessingException("Transaction declined: amounts exceeds gateway limit");
        }
